...
function fetchLeaderboard() {
  ...
  xhr.onload = function() {
    console.log("📥 Statut de réponse:", xhr.status);
    console.log("📄 Contenu de réponse:", xhr.responseText);
    ...
    if (xhr.status === 200) {
      ...
      console.error("Erreur lors de la récupération du leaderboard:", xhr.status, xhr.responseText);
      leaderboardBody.innerHTML = `
        <tr>
          <td colspan="3" class="px-6 py-8 text-center text-red-400">
